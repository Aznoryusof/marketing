...
## Interpretation
- Output of the model is relative to what was set in the intersept
  - In this case, as air is the base, the negative means that air
  has a higher intrinsic utility than bus or car keeping everything
  else constant. Train values are not statistically significant. 
- t-value or standardised coeficient should be used instead as 
a comparison. MUST STANDARDISE INDEPENDENT VARIABLES BEFORE RUNNING 
MODEL TO PROPERLY COMPARE THE COEFFICIENTS.
