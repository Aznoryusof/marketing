...
To note from output above:
- Sensitivity is the true positive rate (Recall)
- Specificity is the true negative rate ()
- 95% CI means that there is a 95% chance that the true hit rate/accuracy would be between 87.4% to 97.8% 
- No information rate means that if we do not include any of the RFM factors into the model, and blindy predict who would be in the larger group (did not buy),
then the hit rate would be 55%
...
Note: AUC means that 98.3% of the time, a buyer will have a higher purchase probability than a non-buyer. Thus a good trust of the model regardless of the metric point.
